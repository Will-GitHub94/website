...
(function () {
	...
	describe('PasswordController', () => {
		...
		describe('Logged in user', () => {
			beforeEach(inject(($controller, $rootScope, _UsersService_, _Authentication_, _$stateParams_, _$httpBackend_, _$location_) => {
		...
		describe('Logged out user', () => {
			beforeEach(inject(($controller, $rootScope, _$window_, _$stateParams_, _$httpBackend_, _$location_, _Notification_) => {
				// Set a new global scope
				scope = $rootScope.$new();
